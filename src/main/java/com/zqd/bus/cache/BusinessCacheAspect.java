...
public class BusinessCacheAspect {
     ...
     * 声明客户的切面表达式
     */
    private static final String POINTCUT_CUSTOMER_ADD="execution(* com.zqd.bus.service.impl.CustomerServiceImpl.save(..))";
    private static final String POINTCUT_CUSTOMER_UPDATE="execution(* com.zqd.bus.service.impl.CustomerServiceImpl.updateById(..))";
    private static final String POINTCUT_CUSTOMER_GET="execution(* com.zqd.bus.service.impl.CustomerServiceImpl.getById(..))";
    private static final String POINTCUT_CUSTOMER_DELETE="execution(* com.zqd.bus.service.impl.CustomerServiceImpl.removeById(..))";
    private static final String POINTCUT_CUSTOMER_BATCHDELETE="execution(* com.zqd.bus.service.impl.CustomerServiceImpl.removeByIds(..))";
     ...
     * 声明货物的切面表达式
     */
    private static final String POINTCUT_GOODS_ADD="execution(* com.zqd.bus.service.impl.GoodsServiceImpl.save(..))";
    private static final String POINTCUT_GOODS_UPDATE="execution(* com.zqd.bus.service.impl.GoodsServiceImpl.updateById(..))";
    private static final String POINTCUT_GOODS_GET="execution(* com.zqd.bus.service.impl.GoodsServiceImpl.getById(..))";
    private static final String POINTCUT_GOODS_DELETE="execution(* com.zqd.bus.service.impl.GoodsServiceImpl.removeById(..))";
    ...
    public Object cacheGoodsGet(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (res1!=null){
            log.info("已从缓存里面找到货物对象"+CACHE_GOODS_PROFIX + object);
            return res1;
        }else {
            log.info("未从缓存里面找到货物对象，从数据库中查询并放入缓存");
    ...
    public Object cacheGoodsUpdate(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (isSuccess){
            ...
            log.info("货物对象缓存已更新"+CACHE_GOODS_PROFIX + goodsVo.getId());
