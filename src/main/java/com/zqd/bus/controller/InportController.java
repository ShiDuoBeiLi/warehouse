...
import com.zqd.bus.vo.InportVo;
...
public class InportController {
    ...
    @RequestMapping("loadAllWarningDate")
    public DataGridView loadAllWarningDate(){
        List<Inport> inports = inportService.loadAllWarningDate();
        return new DataGridView((long) inports.size(),inports);
    }
